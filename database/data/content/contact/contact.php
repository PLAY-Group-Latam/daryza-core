...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | CONTACT GENERAL - Información General
    |--------------------------------------------------------------------------
    */
    'contact_general' => [
        'banner' => [
        ...
        'cards' => [
            [
                ...
                'items' => [
                    ...
                    ['texto' => 'Dudas sobre métodos de pago o facturación'],
                ],
            ],
            [
                ...
                'items' => [
                    ...
                    ['texto' => 'Actualización de datos como distribuidor actual'],
                ],
            ],
            [
                ...
                'items' => [
                    ...
                    ['texto' => 'Información sobre disponibilidad o tiempos de entrega.'],
                ],
            ],
            [
    ...
    /*
    |--------------------------------------------------------------------------
    | CONTACT SERVICE - Servicio al Cliente
    |--------------------------------------------------------------------------
    */
    'contact_service' => [
        'banner' => [
    ...
    /*
    |--------------------------------------------------------------------------
    | CONTACT DISTRIBUTORS - Red de Distribuidores
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | CONTACT ADVISOR - Asesor Comercial
    |--------------------------------------------------------------------------
    */
    'contact_advisor' => [
        'banner' => [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | CONTACT WORK - Trabaja con Nosotros
    |--------------------------------------------------------------------------
    */
    'contact_work' => [
        'banner' => [
