...
import {
    MapPin, Phone, Mail, ChevronLeft, Save, Image as ImageIcon
} from 'lucide-react';
                ...
                <div className="flex items-center justify-between bg-white p-4 rounded-xl shadow-sm border border-slate-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground leading-none">Configura el pin personalizado para Daryza</p>
                        </div>
                    </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    <Upload
                                        ...
                                        placeholder="Subir Logo Pin"
                                        previewClassName="h-28 w-full bg-slate-50 border-dashed border-2"
                                    />
                                    
                                    {/* SIMULADOR DE MARCADOR (PREVIEW FLOTANTE) */}
                                    <div className="absolute -top-1 -right-1 bg-white shadow-lg p-1 rounded-full border border-slate-100 z-10 pointer-events-none">
                                        <div className="relative h-10 w-8">
                                            {/* Si hay logoPreviewUrl, aplicamos máscara. Si no, mostramos el SVG verde normal */}
                                            {logoPreviewUrl ? (
                                                <div
