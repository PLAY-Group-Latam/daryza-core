        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall
                        title="Autenticación de dos factores"
                        description="Administra la configuración de la autenticación en dos pasos"
                    />
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                Puedes obtenerlo desde una app compatible con
                                TOTP en tu teléfono.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                se te pedirá un código seguro al iniciar sesión.
                                Este código se obtiene desde una app compatible
