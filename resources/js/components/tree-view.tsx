        ...
        return (
            <div className={cn('overflow-hidden relative p-2', className)}>
                ...
                <div
                    ...
                    onDrop={(e) => { handleDrop({id: '', name: 'parent_div', isSelected: false})}}>
...
const TreeNode = ({
    ...
    return (
        <AccordionPrimitive.Root
            type="multiple"
            value={item.isSelected ? [item.id] : value}
        ...
        >
            <AccordionPrimitive.Item value={item.id}>
                ...
                >
                    ...
                    <TreeActions isSelected={(selectedItemId === item.id &&  !item.disabled) || item.isSelected}>
                        {item.actions}
                    </TreeActions>
                </AccordionTrigger>
