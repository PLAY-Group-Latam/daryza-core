  ...
  return (
    <>
      ...
      <button type="button" onClick={() => inputRef.current?.click()}
        ...
        {preview ? (
          <>
            <img src={preview} alt="logo preview" className="max-h-32 max-w-[280px] object-contain p-4" />
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-5 border-b border-slate-100 bg-slate-50/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Sube el logo que aparece en el header del sitio.</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 space-y-2">
            ...
            <p className="text-[10px] text-slate-400">Se recomienda fondo transparente para que se vea correctamente en todos los contextos.</p>
          </div>
          ...
          <div>
            ...
            {data.content.image && (
              <p className="mt-2 text-[10px] text-slate-400 text-center">Haz clic en la imagen para cambiarla</p>
            )}
          </div>
