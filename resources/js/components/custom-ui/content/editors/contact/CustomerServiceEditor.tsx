...
import { CustomerServiceContent ,BannerType,BannerContent} from '@/types/content/content-types';
...
export default function CustomerServiceEditor({ section }: Props) {
  ...
  const set = (key: keyof Omit<CustomerServiceContent, 'banner'>, file: File | string | null) =>
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    put(`/content/update/${section.page.slug}/${section.type}/${section.id}`, {
      forceFormData: true,
      preserveScroll: true,
      onSuccess: () => toast.success('¡Servicio al cliente actualizado!'),
