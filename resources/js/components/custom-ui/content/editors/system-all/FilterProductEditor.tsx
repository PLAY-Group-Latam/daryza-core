...
const { data, setData, put, processing, transform } = useForm<{ content: FilterProductContent }>({
  ...
  content: {
    ...
    promo:  { ...values.content.promo,  type: 'image' },
  },
}));
    ...
    <form onSubmit={handleSubmit} className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="px-6 py-5 border-b border-slate-100 bg-slate-50/50 flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-900">Banner Estático</h3>
            <p className="text-sm text-slate-500">Imagen desktop, móvil y enlace para el banner principal.</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="px-6 py-5 border-b border-slate-100 bg-slate-50/50 flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-900">Imagen Promocional</h3>
            <p className="text-sm text-slate-500">Imagen desktop, móvil y enlace para la promoción.</p>
          </div>
        </div>
        ...
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <UploadFixed
                value={data.content.promo.src_mobile}
                onChange={(file) => updatePromo({ src_mobile: file })}
                className="w-[120px] aspect-[9/16]"
              />
            </div>
          </div>
