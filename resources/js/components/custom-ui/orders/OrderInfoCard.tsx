        ...
        <div className="rounded-lg border p-5">
            ...
            <div className="grid gap-4 text-sm md:grid-cols-2">
                ...
                <div>
                    ...
                    <p className="font-semibold">{order.created_at ? formatDate(order.created_at, true) : '-'}</p>
                </div>
                <div>
                    <p className="text-xs text-muted-foreground">Ultima actualizacion</p>
                    <p className="font-semibold">{order.updated_at ? formatDate(order.updated_at, true) : '-'}</p>
                </div>
            </div>
        </div>
    );
